...
class RemoteCacheClient extends EventEmitter {
    ...
    constructor(options = {}) {
        ...
        if(!options.host || typeof options.host != "string") console.log('::[Database Log]: Missing the Option host or the provided form is not a string. Host set to "localhost"')
